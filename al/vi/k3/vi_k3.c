 ...
 *
 *                 Exports a single symbol: al_vi_get_ops()
 *                 MPI resolves this via dlsym and calls through the vtable.
 *------------------------------------------------------------------------------
 */
 ...
 *
 * These functions form the plugin's vtable entries.  They translate the
