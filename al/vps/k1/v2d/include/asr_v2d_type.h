...
#ifndef __ASR_V2D_TYPE_H__
#define __ASR_V2D_TYPE_H__
...
#define V2DLOGD(fmt, ...) printf(fmt, ## __VA_ARGS__)
#else
#define V2DLOGD(fmt, ...)
#endif
...
typedef enum asrV2D_INPUT_LAYER_E {
    V2D_INPUT_LAYER0    =0,
    V2D_INPUT_LAYER1    =1,
    V2D_INPUT_LAYER_NUM =2,
} V2D_INPUT_LAYER_E;

typedef enum asrV2D_FUNCTION_MODE_E {
    V2D_FUNC_DISABLE=0,
    V2D_FUNC_ENABLE =1,
} V2D_FUNCTION_MODE_E;

typedef enum asrV2D_DITHER_E {
    V2D_NO_DITHER   =0,
    V2D_DITHER_4X4  =1,
    V2D_DITHER_8X8  =2,
} V2D_DITHER_E;

typedef enum asrV2D_ROTATE_ANGLE {
    V2D_ROT_0       =0,
    V2D_ROT_90      =1,
    V2D_ROT_180     =2,
    V2D_ROT_270     =3,
...
typedef enum asrV2D_BLENDCMD_E {
    V2D_BLENDCMD_ALPHA  = 0,
    V2D_BLENDCMD_ROP2   = 1,
    V2D_BLENDCMD_BUTT
} V2D_BLENDCMD_E;

typedef enum asrV2D_MASKCMD_E {
...
typedef enum asrV2D_BLENDALPHA_SOURCE_E {
...
typedef enum asrV2D_BLEND_PRE_ALPHA_FUNC_E {
...
typedef enum asrV2D_BLEND_MODE_E {
    V2D_BLEND_ZERO = 0x0,
    V2D_BLEND_ONE,
    V2D_BLEND_SRC_ALPHA,
...
typedef enum asrV2D_ROP2_MODE_E {
    V2D_ROP2_BLACK      =0,
...
typedef enum asrV2D_COLOR_FORMAT_E {
...
typedef enum asrV2D_CSC_MODE_E {
...
typedef enum asrFBC_DECODER_MODE_E {
...
typedef enum asrFBC_DECODER_FORMAT_E {
...
typedef struct asrV2D_FILLCOLOR_S {
    uint32_t colorvalue;
    V2D_COLOR_FORMAT_E format;
} V2D_FILLCOLOR_S;

typedef struct asrV2D_BACKGROUND_S {
    V2D_FILLCOLOR_S fillcolor;
    bool enable;
} V2D_BACKGROUND_S;

typedef struct asrV2D_SOLIDCOLOR_S {
    V2D_FILLCOLOR_S fillcolor;
    bool enable;
} V2D_SOLIDCOLOR_S;

typedef struct asrV2D_PALETTE_S {
    uint8_t palVal[1024];
    int len;
} V2D_PALETTE_S;

typedef struct asrFBC_DECODER_S {
    int fd;
...
typedef struct asrFBC_ENCODER_S {
	int fd;
	int offset;
    uint32_t headerAddr_h;
    uint32_t headerAddr_l;
...
typedef struct asrV2D_SURFACE_S {
    struct {
        bool fbc_enable;
        int fd;
        int offset;
