...
enum v4l2_mvx_range { V4L2_MVX_RANGE_UNSPECIFIED, V4L2_MVX_RANGE_FULL, V4L2_MVX_RANGE_LIMITED };
...
#define VIDIOC_G_MVX_COLORDESC _IOWR('V', BASE_VIDIOC_PRIVATE, struct v4l2_mvx_color_desc)
#define VIDIOC_S_MVX_ROI_REGIONS _IOWR('V', BASE_VIDIOC_PRIVATE + 1, struct v4l2_mvx_roi_regions)
#define VIDIOC_S_MVX_QP_EPR _IOWR('V', BASE_VIDIOC_PRIVATE + 2, int)
#define VIDIOC_S_MVX_COLORDESC _IOWR('V', BASE_VIDIOC_PRIVATE + 3, struct v4l2_mvx_color_desc)
#define VIDIOC_S_MVX_SEI_USERDATA _IOWR('V', BASE_VIDIOC_PRIVATE + 4, struct v4l2_sei_user_data)
#define VIDIOC_S_MVX_RATE_CONTROL _IOWR('V', BASE_VIDIOC_PRIVATE + 5, struct v4l2_rate_control)
#define VIDIOC_S_MVX_DSL_FRAME _IOWR('V', BASE_VIDIOC_PRIVATE + 6, struct v4l2_mvx_dsl_frame)
#define VIDIOC_S_MVX_DSL_RATIO _IOWR('V', BASE_VIDIOC_PRIVATE + 7, struct v4l2_mvx_dsl_ratio)
#define VIDIOC_S_MVX_LONG_TERM_REF _IOWR('V', BASE_VIDIOC_PRIVATE + 8, struct v4l2_mvx_long_term_ref)
#define VIDIOC_S_MVX_DSL_MODE _IOWR('V', BASE_VIDIOC_PRIVATE + 9, int)
/****************************************************************************
 * Custom controls
 ****************************************************************************/
