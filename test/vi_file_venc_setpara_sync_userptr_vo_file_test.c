...
#define SET_PARA_CMD MPP_VENC_CMD_SET_PARAM_HEVC_CBR
...
static void Set_Enc_Para(MppVencCmd cmd, TestContext *context) {
  switch (cmd) {
    case MPP_VENC_CMD_SET_PARAM_H264_CBR:
      MppVencParaH264CBR *Param_H264_CBR = malloc(sizeof(MppVencParaH264CBR));
      Param_H264_CBR->nGop = 32;
      Param_H264_CBR->nMinQP = 10;
      Param_H264_CBR->nMaxQP = 20;
      VENC_SetParam(context->pVencCtx, MPP_VENC_CMD_SET_PARAM_H264_CBR,
                    (void *)Param_H264_CBR);
      break;
    ...
    case MPP_VENC_CMD_SET_PARAM_H264_VBR:
      MppVencParaH264VBR *Param_H264_VBR = malloc(sizeof(MppVencParaH264VBR));
      Param_H264_VBR->nGop = 32;
      Param_H264_VBR->nMinQP = 10;
      Param_H264_VBR->nMaxQP = 20;
      VENC_SetParam(context->pVencCtx, MPP_VENC_CMD_SET_PARAM_H264_VBR,
                    (void *)Param_H264_VBR);
      break;
    ...
    MppVencParaH264CVBR *Param_H264_CVBR = malloc(sizeof(MppVencParaH264CVBR));
      Param_H264_CVBR->nGop = 32;
      Param_H264_CVBR->nMinQP = 10;
      Param_H264_CVBR->nMaxQP = 20;
      VENC_SetParam(context->pVencCtx, MPP_VENC_CMD_SET_PARAM_H264_CVBR,
                    (void *)Param_H264_CVBR);
      break;
    case MPP_VENC_CMD_SET_PARAM_HEVC_CVBR:
      MppVencParaHEVCCVBR *Param_HEVC_CVBR = malloc(sizeof(MppVencParaHEVCCVBR));
      Param_HEVC_CVBR->nGop = 5;
      Param_HEVC_CVBR->nMinQP = 20;
      Param_HEVC_CVBR->nMaxQP = 40;
