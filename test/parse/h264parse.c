 ...
 * @LastEditTime: 2023-11-09 16:11:33
 * @Description:
 */
...
S32 PARSE_H264_Parse(MppParseContext *ctx, U8 *stream_start_addr,
                     ...
                     S32 is_first_seq_header, S32 last) {
  S32 i = 0;
  ...
  while (1) {
...

    {
      ...
      if (0x06 == tmp_0 || 0x07 == tmp_0 || 0x08 == tmp_0) {
        ...
        if (1 == num_start_code) num_start_code++;
      }
      ...
      if (0x01 == tmp_0 || 0x05 == tmp_0)  // non-IDR picture, IDR picture
      {
        ...
        if (0x80 == tmp_1)  // first slice of frame
        {
           ...
           */
          num_start_code++;
          if (1 == num_start_code && 0 == hd_start_code) start_pos = rbsp_base;
        }
  ...
  if (1 == num_start_code && last) {
    debug("stream_size = %d", stream_size);
