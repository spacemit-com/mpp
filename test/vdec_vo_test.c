 ...
 * @LastEditTime: 2024-03-15 18:08:34
 * @Description:
 */
...
S32 main(S32 argc, char **argv) {
  ...
  // set para
  context->pVoCtx->eVoType = 101;
  context->pVoCtx->stVoPara.eVoType = 101;
  ...
  while (1) {
    if (context->pVdecCtx->stVdecPara.eDataTransmissinMode ==
      ...
      if (ret == MPP_OK) {
        ...
        context->nWidth = context->pVdecCtx->stVdecPara.nWidth;
        context->nHeight = context->pVdecCtx->stVdecPara.nHeight;
        continue;
